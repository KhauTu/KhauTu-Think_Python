class Card:
    ...
    # define the six special methods that do the overloading of each of the relational operators
...
class Deck:
    ...
    # the Boolean function is_empty, which returns True if the deck contains no cards.
    def is_empty(self):
        return self.cards == []
