...
class DukeSprite:
    ...
    def update(self):
        if self.anim_frame_count > 0:
            self.anim_frame_count = (self.anim_frame_count + 1 ) % 30
            self.curr_patch_num = self.anim_frame_count // 3
...
# Create a sprite object for each queen, and populate our list.
    ...
    while True:
        ...
        my_clock.tick(30) # Waste time so that frame rate becomes 60 fps
    '''    
    while True:
